            ...
            <div className='h-[35em] w-full bg-loguin-blue'>
              <div className='flex h-full w-full flex-col items-center justify-center px-12'>
                ...
                <p className='w-full text-justify text-white'>
                  ...
                  de dados, criam-se funcionalidades como formação de preço, movimentação
                  de materiais (compra, empenho e uso), registros financeiros e muitas
                  outras funções. Como o sistema é integrado, não há redigitação
                  (portanto, sem erros), unindo os dados da produção com a administração.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className='h-[35em] w-full bg-loguin-blue'>
              <div className='flex h-full w-full flex-col items-center justify-center px-12'>
                ...
                <p className='w-full text-justify text-white'>
                  ...
                  dados e fornecendo relatórios precisos e concisos. Ao aprimorar a parte
                  operacional do seu negócio, essa ferramenta permite que o gestor consiga
                  satisfazer seus clientes e ampliar as vendas.
                </p>
              </div>
            </div>
          ...
          <div className='my-8 grid w-full grid-cols-1 gap-4 md:grid-cols-2'>
            ...
            <div className='icones-etapas'>
              <div className='contato'>
                ...
                <p className='mt-2'>
                  No contato inicial, vamos precisar de informações gerais do seu negócio,
                  como porte e segmento. Com isso, vamos agendar uma reunião.
                </p>
              </div>

              <div className='entendimento mt-4'>
                <p className='font-bold'>
                  <span className='mr-[0.5rem] text-loguin-red'>2.</span> ENTENDIMENTO DO
                  NEGÓCIO
                </p>
                <p className='mt-2'>
                  Durante esse processo, vamos entender as suas necessidades e a dinâmica
                  da sua gráfica, para pensar a melhor estratégia de implantação do
                  sistema.
                </p>
              </div>
